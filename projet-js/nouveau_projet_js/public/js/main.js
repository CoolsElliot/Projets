/*DARK MODE*/
    ...
    /*Stock des éléments HTML dans des variables */

    /*Nav elements*/

        let navBar = document.querySelector("nav");
        let titrePrincipal = document.querySelector("h1");
        let dropdownMenu = document.querySelector("a");
        let liensNav1 = document.querySelector("ul").querySelectorAll("a");
        let liensNav2 = document.querySelectorAll("ul")[1].querySelectorAll("a");
        let listmenu = document.querySelector("#menulist");
        let darkText = document.querySelector("#dark");
        let icones = document.querySelectorAll("ul")[2].querySelectorAll("i");
        let compteur1 = document.querySelector("#compteur1");
        let compteur2 = document.querySelector("#compteur2");
        let buttonDark = document.querySelector("#flexSwitchCheckDefault");
...
/*Fonctions*/
    ...
    function setStyleDark (){
        ...
        titrePrincipal.style.color = "white";
        dropdownMenu.style.backgroundColor = "white";
        dropdownMenu.style.color = "black";
        for(let i = 0; i < liensNav1.length; i++){
            liensNav1[i].style.color = "white";
        };
            
        for(let i = 0; i < liensNav2.length; i++){
            liensNav2[i].style.color = "white";
        };
        menulist.style.backgroundColor = "black";
        darkText.style.color = "white";
        for(let i = 0; i < icones.length; i++){
            icones[i].style.color = "white";
        }
        compteur1.style.backgroundColor = "white";
        compteur2.style.backgroundColor = "white";
        compteur1.style.color = "black";
        compteur2.style.color = "black";
            
    };

    function setStyleLight (){
        navBar.style.backgroundColor = "rgb(245,235,223)";
        titrePrincipal.style.color = "black";
        dropdownMenu.style.backgroundColor = "black";
        dropdownMenu.style.color = "white";
        for(let i = 0; i < liensNav1.length; i++){
            liensNav1[i].style.color = "black";
        };
            
        for(let i = 0; i < liensNav2.length; i++){
            liensNav2[i].style.color = "black";
        };
        menulist.style.backgroundColor = "grey";
        darkText.style.color = "black";
        for(let i = 0; i < icones.length; i++){
            icones[i].style.color = "black";
        }
        compteur1.style.backgroundColor = "black";
        compteur2.style.backgroundColor = "black";
        compteur1.style.color = "white";
        compteur2.style.color = "white";
